...
@section('title', 'Nouvelle tâche - ' . $project->name)
    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-4">
          <h5 class="card-title fw-semibold mb-0">Nouvelle tâche - {{ $project->name }}</h5>
        ...
        <form action="{{ route('tasks.store', $project) }}" method="POST">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <select class="form-select @error('category') is-invalid @enderror" id="category" name="category">
                ...
                <option value="maçonnerie" {{ old('category') == 'maçonnerie' ? 'selected' : '' }}>Maçonnerie</option>
                <option value="fondations" {{ old('category') == 'fondations' ? 'selected' : '' }}>Fondations</option>
                ...
                <option value="charpente" {{ old('category') == 'charpente' ? 'selected' : '' }}>Charpente</option>
                <option value="isolation" {{ old('category') == 'isolation' ? 'selected' : '' }}>Isolation</option>
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                <option value="a_faire" {{ old('status', 'a_faire') == 'a_faire' ? 'selected' : '' }}>À faire</option>
                ...
                <option value="bloque" {{ old('status') == 'bloque' ? 'selected' : '' }}>Bloqué</option>
              </select>
              @error('status')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            ...
            <div class="col-md-6 mb-3">
              ...
              <select class="form-select @error('priority') is-invalid @enderror" id="priority" name="priority" required>
                <option value="basse" {{ old('priority', 'moyenne') == 'basse' ? 'selected' : '' }}>Basse</option>
          ...
          <div class="mb-3">
            ...
            <input type="number" min="0" max="100" class="form-control @error('progress') is-invalid @enderror" id="progress" name="progress" value="{{ old('progress', 0) }}">
            @error('progress')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
