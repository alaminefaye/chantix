                  ...
                  <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <audio controls class="w-100" style="max-width: 100%;">
                        <source src="{{ asset('storage/' . $progressUpdate->audio_file) }}" type="audio/mpeg">
                        <source src="{{ asset('storage/' . $progressUpdate->audio_file) }}" type="audio/mp4">
                        <source src="{{ asset('storage/' . $progressUpdate->audio_file) }}" type="audio/wav">
