      ...
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-4">
          ...
          <div class="d-flex gap-2">
            @if(auth()->user()->isSuperAdmin() || auth()->user()->hasRoleInCompany('admin', $project->company_id) || auth()->user()->hasPermission('expenses.create', $project->company_id))
              ...
              @empty
                <tr>
                  <td colspan="7" class="text-center py-4">
                    <p class="mb-0">Aucune dépense trouvée.@if(auth()->user()->isSuperAdmin() || auth()->user()->hasRoleInCompany('admin', $project->company_id) || auth()->user()->hasPermission('expenses.create', $project->company_id)) <a href="{{ route('expenses.create', $project) }}">Créer une dépense</a>@endif</p>
                  </td>
                </tr>
              @endforelse
            </tbody>
