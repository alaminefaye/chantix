...
@section('title', 'Importer des matériaux')
    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-4">
          <h5 class="card-title fw-semibold mb-0">Importer des matériaux depuis Excel</h5>
        ...
        <div class="alert alert-info mb-4">
          ...
          <ol class="mb-0">
            ...
            <li>Colonnes requises : <strong>Nom</strong>, <strong>Unité</strong></li>
            <li>Colonnes optionnelles : Description, Catégorie, Prix unitaire, Stock actuel, Stock minimum, Référence, Fournisseur</li>
            <li>Uploadez le fichier rempli</li>
          </ol>
        </div>

        <form action="{{ route('materials.import.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="d-flex gap-2">
            ...
            <a href="{{ route('materials.template.download') }}" class="btn btn-outline-primary">
