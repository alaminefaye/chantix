      ...
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-4">
          ...
          <div class="d-flex gap-2">
            ...
            @if(auth()->user()->isSuperAdmin() || auth()->user()->hasRoleInCompany('admin', auth()->user()->current_company_id) || auth()->user()->hasPermission('projects.create', auth()->user()->current_company_id))
            ...
            @empty
              <div class="col-12">
                <div class="alert alert-info">
                  ...
                  Aucun projet avec coordonnées GPS trouvé.@if(auth()->user()->isSuperAdmin() || auth()->user()->hasRoleInCompany('admin', auth()->user()->current_company_id) || auth()->user()->hasPermission('projects.create', auth()->user()->current_company_id)) <a href="{{ route('projects.create') }}">Créer un projet</a>@endif
                </div>
              </div>
            @endforelse
          </div>
              ...
              @empty
                <tr>
                  <td colspan="6" class="text-center py-4">
                    <p class="mb-0">Aucun projet trouvé.@if(auth()->user()->isSuperAdmin() || auth()->user()->hasRoleInCompany('admin', auth()->user()->current_company_id) || auth()->user()->hasPermission('projects.create', auth()->user()->current_company_id)) <a href="{{ route('projects.create') }}">Créer un projet</a>@endif</p>
                  </td>
                </tr>
              @endforelse
            </tbody>
